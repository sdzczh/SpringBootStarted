...
public enum ResultCode {
    ...
    ORDER_C2C_MARKER_SALE_LIMIT(30070, "您已有一笔委托，请在未成交订单中撤消后继续发布"),
    DAY_TASK_SUCCESS(30071, "每日奖励领取成功"),
    DAY_TASK_FALSE(30072, "这个任务今天已经完成啦，请明天再来"),
    TAKL_FRIEND_EXIST(30073, "好友已存在"),
    TAKL_FRIEND_APPLY_NOTEXIST(30074, "好友申请不存在"),
    TAKL_FRIEND_APPLY_DEALED(30075, "好友申请已处理"),
    TAKL_FRIEND_NOT_EXIST(30076, "好友不存在"),
    TAKL_FRIEND_APPLY_EXIST(30077, "好友申请正在处理中"),
    TAKL_GROUP_TYPE_ERROR(30078, "群组类型错误"),
    TAKL_GROUP_NOT_EXIST(30079, "群组不存在"),
    TAKL_REDPACKET_AMOUNT_MINERROR(30080, "红包金额必须大于0"),
    TAKL_REDPACKET_AMOUNT_MAXERROR(30081, "单个红包金额必须小于%s"),
    TAKL_REDPACKET_NOT_EXIST(30082, "红包不存在"),
    TAKL_REDPACKET_FINISHED(30083, "红包已经领取完了"),
    TAKL_REDPACKET_ERROR(30084, "红包领取失败"),
    TAKL_FRIEND_NOT_SELF(30085, "不能添加自己为好友"),
    TAKL_TRANSFER_AMOUNT_MAXERROR(30086, "每日最多转%s"),
    TAKL_REDPACKET_NOT_SELF(30087, "不能给自己发红包"),
    TAKL_GROUP_USER_NOT_EXIST(30088, "用户不在该群组中"),
    TAKL_GROUP_OWNER_CANNOT_LEAVE(30089, "群主不能退群"),
    ORDER_SPOT_FAIL(30090, "交易失败"),
    ORDER_SPOT_AMOUNT_LESS_THAN_MIN(30091, "最小交易数量为%s"),
    ORDER_SPOT_PRICE_LESS_THAN_MIN(30092, "最小交易金额为%s"),
    RECHARGE_RECH_SPOT_OFF(30093, "充值未开启"),
    RECHARGE_RECH_FLASE(30094, "充值信息获取失败"),
